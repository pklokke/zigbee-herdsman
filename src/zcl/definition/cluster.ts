...
= {
    ...
    hvacThermostat: {
        ...
        attributes: {
            ...
            wiserSmartPriorityLevel: {ID: 0xe000, type: DataType.uint8, manufacturerCode: ManufacturerCode.SCHNEIDER},
            wiserSmartMasterShortAddress: {ID: 0xe001, type: DataType.uint16, manufacturerCode: ManufacturerCode.SCHNEIDER},
            wiserSmartZoneMode: {ID: 0xe010, type: DataType.enum8, manufacturerCode: ManufacturerCode.SCHNEIDER},
            wiserSmartHactConfig: {ID: 0xe011, type: DataType.bitmap8, manufacturerCode: ManufacturerCode.SCHNEIDER},
            wiserSmartValvePosition: {ID: 0xe030, type: DataType.uint8, manufacturerCode: ManufacturerCode.SCHNEIDER},
            wiserSmartValveCalibrationStatus: {ID: 0xe031, type: DataType.enum8, manufacturerCode: ManufacturerCode.SCHNEIDER},
